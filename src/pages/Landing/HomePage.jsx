...
export const HomePage = () => {
  ...
  useEffect(() => {
    setParallaxHeight(document.getElementsByClassName("parallax")[0].clientHeight);
    setParallaxWidth(document.getElementsByClassName("parallax")[0].clientWidth);
  }, [])

  const {scrollY} = useViewportScroll();
  const firstLayerOpacity = useTransform(scrollY, [0, parallaxHeight*0.25], [1, 0])
  const secondLayerOpacity = useTransform(scrollY, [0, parallaxHeight*0.5], [1, 0])
  const thirdLayerOpacity = useTransform(scrollY, [0, parallaxHeight*0.75], [1, 0])
  const fourthLayerOpacity = useTransform(scrollY, [0, parallaxHeight*0.9], [1, 0])
  const secondLayerPosition = useTransform(scrollY, [0, parallaxHeight*0.5], [0, -parallaxHeight/2])
  const thirdLayerPosition = useTransform(scrollY, [0, parallaxHeight*0.75], [0, parallaxHeight/2])
  const fourthLayerPosition = useTransform(scrollY, [0, parallaxHeight], [0, parallaxHeight/2])
  ...
  return (
    <Template>
      <div className="parallax">
        ...
        <motion.div className="logo-wrap" style={{opacity: secondLayerOpacity}}>
            <img src={Logo} alt="Logo Wisuda April" className="logo"/>
            <h6 className="logo-desc"><i>“To be wise is to accept change. To be enlightened is to love change.”</i></h6>
