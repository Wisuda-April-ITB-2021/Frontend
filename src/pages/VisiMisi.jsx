            ...
            <div className="visi-misi-wrapper">
                ...
                <div className="visi-misi">
                    ...
                    <section className = "misi">
                        <h3> MISI </h3>
                        <ol>
                            <li>Menjadikan Perayaan Wisuda April 2021 sebagai wadah apresiasi
                                 purnastudi melalui optimalisasi potensi yang hadir dalam
                                 perubahan dimensi.</li>
                            <li>Mewadahi keberagaman elemen KM ITB lewat terciptanya wisuda
                                 ...
                                 setiap elemen KM ITB.</li>
                            <li>Mewadahi kebutuhan wisudawan tentang kebutuhan pasca kelulusan</li>
                        </ol>
